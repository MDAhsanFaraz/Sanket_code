...
async function process1() {
          val1 = await downloadData("process1");// when we go into await after that control is thrown out of the async function//async funciton goes in the callstack and is thrown outside of the call stack // even you have a immediate resolved promise
