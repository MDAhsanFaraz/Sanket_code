...
console.log("start");
let p=processing();
console.log(p);// prints the pending value 
p.then((value)=>{
          console.log(p,value);// as asyn funciton returns a promise we are printing value of p inside .then as it prints 
          // after the promise is fullfiled 
          // both value and p has value which was returned by the asyn function  
})
console.log("end");
